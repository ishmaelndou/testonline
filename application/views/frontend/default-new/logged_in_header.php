            ...
            <div class="row"> 
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="icon icon-left">
                        <ul class="nav">
                            <li class="nav-item px-2"><a href="#"><i class="fa-solid fa-phone"></i> </a></li>
                            <div class="vartical"></div> 
                            <li class="nav-item px-2"><a href="#"><i class="fa-solid fa-location-dot"></i> Midrand, Gauteng</a></li>   
                        </ul>
                    </div>
                </div>
            ...
            <div class="offcanvas-body">
                <div class="offcanvas-items">
                    <ul class="navbar-nav main-nav-wrap me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a  class="nav-link header-dropdown" href="#">Economic Calender
                            </a>
                        </li>
